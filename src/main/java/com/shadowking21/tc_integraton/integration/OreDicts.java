...
public class OreDicts {
    ...
    {
        AspectMetalProcessing.MainAspectMetalProcessing(event);
        ...
        register.registerObjectTag("oreIlmenite", (new AspectList().add(Aspect.METAL, 20).add(Aspect.PROTECT, 10).add(Aspect.MECHANISM, 5)));
        register.registerObjectTag("dustClay", (new AspectList().add(Aspect.EARTH, 5).add(Aspect.WATER, 5)));
        register.registerObjectTag("plankTreatedWood", (new AspectList().add(Aspect.PLANT, 3).add(Aspect.TRAP, 3)));
    }
}
